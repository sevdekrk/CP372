...
public class Board {
   ...
   private static final List<String> COLOR_LIST =
           List.of("white", "red", "blue", "yellow", "green");
   private static final Set<String> COLOR_SET = new HashSet<>(COLOR_LIST);
   ...
   public List<String> getValidColors() { return COLOR_LIST; }
   ...
   // GET notes with filters (multi-line)
